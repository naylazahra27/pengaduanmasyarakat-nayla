          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              ...
              <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h6 class="font-weight-normal mb-0">Ini adalah data pengaduan dari masyarakat</h6>
                </div>
              </div>
            </div>
          </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/tanggapan/destroy/{{ $p->id_tanggapan }}" class="btn btn-danger fa-fa-trash">Hapus</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
